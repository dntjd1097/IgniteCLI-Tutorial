...
const (
	...
	Msg_CreatePost_FullMethodName   = "/hello.hello.Msg/CreatePost"
	Msg_UpdatePost_FullMethodName   = "/hello.hello.Msg/UpdatePost"
	Msg_DeletePost_FullMethodName   = "/hello.hello.Msg/DeletePost"
)
