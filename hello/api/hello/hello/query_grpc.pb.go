...
const (
	...
	Query_SayHello_FullMethodName = "/hello.hello.Query/SayHello"
	Query_Post_FullMethodName     = "/hello.hello.Query/Post"
	Query_PostAll_FullMethodName  = "/hello.hello.Query/PostAll"
)
